...
## 🚀 Experimental Results & Ablations (March 2026)

### Evaluation Setup
- Corpus: 377 SHL psychometric assessments (embedded with all-MiniLM-L6-v2 + FAISS)
...
**Mitigation implemented**: Metadata-aware post-filter (assessment_type + competency tags).

Full notebook & code: `src/scripts/batch_predict.py` + `notebooks/failure_mode_analysis.ipynb`  
